...
class PashuBazaarMyPostsPagerAdapter(holder: MyPostsAdapter.MyViewHolder, images: ArrayList<Uri>) :
    RecyclerView.Adapter<PashuBazaarMyPostsPagerAdapter.PashuBazaarCardImageViewHolder>() {
