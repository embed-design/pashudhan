...
class PashuBazaarFavPostPagerAdapter(holder: FavouritePostsAdapter.MyViewHolder, images: ArrayList<Uri>) :
    RecyclerView.Adapter<PashuBazaarFavPostPagerAdapter.PashuBazaarCardImageViewHolder>() {
